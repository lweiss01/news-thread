...
<execution_context>
@.agent/GSD/workflows/execute-plan.md
@.agent/GSD/templates/summary.md
[If plan contains checkpoint tasks (type="checkpoint:*"), add:]
@.agent/GSD/references/checkpoints.md
</execution_context>
...
<!-- For checkpoint task examples and patterns, see @.agent/GSD/references/checkpoints.md -->
...
See `.agent/GSD/references/tdd.md` for TDD plan structure.
...
See `.agent/GSD/templates/user-setup.md` for full schema and examples
...
See `.agent/GSD/workflows/verify-phase.md` for verification logic.
