...
- Usage: Reference from command with `@.agent/GSD/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to .agent/GSD/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to .agent/GSD/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
