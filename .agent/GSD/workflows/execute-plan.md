...
@.agent/GSD/references/git-integration.md
</required_reading>
...
See .agent/GSD/references/checkpoints.md for complete checkpoint guidance.
</step>
...
Create `.planning/phases/XX-name/{phase}-USER-SETUP.md` using template from `.agent/GSD/templates/user-setup.md`.
...
Use .agent/GSD/templates/summary.md for structure.
