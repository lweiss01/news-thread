---
name: gsd:transition
description: Mark current phase complete and advance to next. This is the natural point where progress tracking and PROJECT.md evolution happen.  "Planning next phase" = "current phase is done"
allowed-tools:
  - Read
  - Write
  - Edit
