...
description: Verify phase goal achievement through goal-backward analysis. Check that the codebase actually delivers what the phase promised, not just that tasks were completed.
argument-hint: ""
allowed-tools:
  - Read
  - Write
...
<required_reading>
@.agent/GSD/references/verification-patterns.md
@.agent/GSD/templates/verification-report.md
</required_reading>
...
See .agent/GSD/templates/verification-report.md for complete template.
</step>
