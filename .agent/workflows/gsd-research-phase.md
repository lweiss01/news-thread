...
description: Research how to implement a phase. Spawns gsd-phase-researcher with phase context.  Standalone research command. For most workflows, use `/gsdplan-phase` which integrates research automatically.
allowed-tools:
  - Read
  - Write
  - Edit
