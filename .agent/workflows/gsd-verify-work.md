...
description: Validate built features through conversational testing with persistent state. Creates UAT.md that tracks test progress, survives /clear, and feeds gaps into /gsdplan-phase --gaps.  User tests, Cla...
allowed-tools:
  - Read
  - Write
  - Edit
