---
name: gsd:health
description: Validate `.planning/` directory integrity and report actionable issues. Checks for missing files, invalid configurations, inconsistent state, and orphaned plans. Optionally repairs auto-fixable iss...
allowed-tools:
  - Read
  - Write
  - Edit
...
```bash
node C:/Users/lweis/.claude/get-shit-done/bin/gsd-tools.cjs validate health $REPAIR_FLAG
```
...
```bash
node C:/Users/lweis/.claude/get-shit-done/bin/gsd-tools.cjs validate health
```
