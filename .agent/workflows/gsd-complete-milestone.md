...
description: Mark a shipped version as complete, archive roadmap/requirements, and tag release
argument-hint: ""
allowed-tools:
  - Read
  - Write
...
1. .agent/GSD/templates/milestone.md
2. .agent/GSD/templates/milestone-archive.md
...
**ROADMAP archive** uses `.agent/GSD/templates/milestone-archive.md` template with:
...
Use template from `.agent/GSD/templates/milestone.md`:
...
2. Read `.agent/GSD/templates/milestone-archive.md` template
...
Archived: v[X.Y]
Tag: v[X.Y]
Clean slate created for next milestone.
