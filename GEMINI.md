...
5. Use `./.holistic/system/holistic resume --agent antigravity` on macOS/Linux or `.\.holistic\system\holistic.cmd resume --agent antigravity` on Windows to register the session.
